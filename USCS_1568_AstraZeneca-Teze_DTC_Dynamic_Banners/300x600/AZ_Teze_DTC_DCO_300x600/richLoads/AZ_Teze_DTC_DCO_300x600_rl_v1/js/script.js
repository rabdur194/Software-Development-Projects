...
function init() {
  ...
  tl.to(['#bg','#solidBg'], 0.25, { autoAlpha: 1 }, "+=0");
  tl.to('#headline1', 0.5, { y: 0, autoAlpha: 1 },"+=0.0"); 
 
  tl.to('#bg', 4.5, { scaleX: 1.5, scaleY: 1.6, x:56, y:-32 }); 
  tl.to('#headline1', 0.5, { autoAlpha: 0 }, "-=2");
  tl.to('#headline2', 0.5, { autoAlpha: 1 }, "-=1.5");
  // die
  tl.to('#bg', 1.75, { scale: 1, x:0, y:0 });
  tl.to(['#solidBg','#headline2'], 0.5, { autoAlpha: 0 }, "+=0");
 
  tl.to(['#logo','#indication','#ISIWrapper', '#ISIFooter'], 0.5, { autoAlpha: 1}, "-=0");
  tl.to(['#legal','#headline3'], 0.5, { autoAlpha: 1 }, "+=0.0");

  tl.to('#headline3', 0.5, { autoAlpha: 0 }, "+=3.5");
  
  tl.to('#headline4', 0.5, { autoAlpha: 1 }, "+=0.0");
...
// tl.to('#bg', 2, { scale: 1.5, x:37, y:-25 } );
// tl.to('#bg', 5, { scale: 1.2, x:-218, y:-259 }); 
