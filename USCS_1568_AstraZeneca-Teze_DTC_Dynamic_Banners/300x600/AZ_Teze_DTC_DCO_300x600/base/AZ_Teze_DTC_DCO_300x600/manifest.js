FT.manifest({
    ...
    "hideBrowsers": ["ie8"],
    "richLoads": [
        { "name": "main_rl","src": "AZ_Teze_DTC_DCO_300x600_rl_v1" }
    ],
    "instantAds": [
        { "name": "main_rl",
            "type": "richload",
            "default": "AZ_Teze_DTC_DCO_728x90_rl"
        },
        { "name": "F1headlineTxt_size_hex_xy",
            "type": "text",
            "default": "READY FOR FEWER<br>ASTHMA ATTACKS|31|#fff|31,467"
        },
        { "name": "F2headlineTxt_size_hex_xy",
            "type": "text",
            "default": "BETTER BREATHING<br>AND IMPROVED<br>LUNG FUNCTION?|30.2|#fff|25,452"
        },
        { "name": "F3headlineTxt_size_hex_xy",
            "type": "text",
            "default": "TEZSPIRE is here to<br>help you along your<br>asthma journey,<br>no matter who you are.|19|#003869|0,92"
        },
        { "name": "F4headlineTxt_size_hex_xy",
            "type": "text",
            "default": "TEZSPIRE offers support<br>with tips, tools and<br>personalized resources.|18|#003869|0,88"
        },
        { "name": "F4_legal_Txt_size_hex_xy",
            "type": "text",
            "default": "Tezspire is an add-on maintenance treatment for people aged 12<br>and older with severe asthma. TEZSPIRE is not a rescue medication.|10|#003869|15,377"
        },
        { "name": "ISI_txt",
            "type": "text",
            ...
            <p><span class="bold">TEZSPIRE may cause serious side effects, including:</span>
             ...
             Sore throat, joint and back pain. These are not all the<br/>
        ...
        { "name": "cta_txt_size_hex_xy",
            "type": "text",
            "default": "LET'S GET STARTED|14.5|#fff|65,149"
        },
        { "name": "clickTag1_url",
            "type": "text",
            "default": ""
        ...
        { "name": "logo_img",
            "type": "image",
            "default": "images/Teze_DTC_DCO_logo_300x600.png"
        },
        { "name": "background_img",
            "type": "image",
            "default": "images/300x600_Teze_DTC_DCO_bg_hero_img.png"
        }
    ]
});