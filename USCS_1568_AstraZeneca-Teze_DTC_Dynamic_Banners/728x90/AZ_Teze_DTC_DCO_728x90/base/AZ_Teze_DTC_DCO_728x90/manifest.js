FT.manifest({
    ...
    "hideBrowsers": ["ie8"],
    "richLoads": [
        { "name": "main_rl","src": "AZ_Teze_DTC_DCO_728x90_rl_v1" }
    ],
    "instantAds": [
        { "name": "main_rl",
            "type": "richload",
        ...
        { "name": "F1headlineTxt_size_hex_xy",
            "type": "text",
            "default": "READY FOR FEWER ASTHMA ATTACKS,|24|#003869|150,33"
        },
        { "name": "F2headlineTxt_size_hex_xy",
            "type": "text",
            "default": "BETTER BREATHING AND IMPROVED<br>LUNG FUNCTION?|24|#003869|150,20"
        },
        { "name": "F3headlineTxt_size_hex_xy",
            "type": "text",
            "default": "TEZSPIRE is here to help you along your<br>asthma journey, no matter who you are.|16|#003869|162,28"
        },
        { "name": "F4headlineTxt_size_hex_xy",
            "type": "text",
            "default": "TEZSPIRE offers support with tips, tools<br>and personalized resources.|16|#003869|162,4"

        },
        { "name": "F4_legal_Txt_size_hex_xy",
            "type": "text",
            "default": "Tezspire is an add-on maintenance treatment for people aged 12 and older with severe asthma. TEZSPIRE is not a rescue medication.|8.5|#003869|23,75"
        },
        { "name": "ISI_txt",
            "type": "text",
        ...
        { "name": "cta_txt_size_hex_xy",
            "type": "text",
            "default": "SIGN UP NOW|12|#fff|254,42"
        },
        { "name": "clickTag1_url",
            "type": "text",
            "default": ""
        ...
        { "name": "logo_img",
            "type": "image",
            "default": "images/Teze_DTC_DCO_logo_728x90.png"
        },
        { "name": "background_img",
            "type": "image",
            "default": "images/728x90_Teze_DTC_DCO_bg_hero_img.png"
        }
    ]
});