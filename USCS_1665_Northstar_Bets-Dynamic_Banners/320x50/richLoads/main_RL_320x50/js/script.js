var iaObject={},dom={},main,feedItems,adWidth,adHeight;
var imagesRequested=0,imagesLoaded=0,timeoutcalled=false,displayAdCalled=false;
...
function checkPlatform() {//MANDATORY_Check browser/user agent and return.
    try {
        ...
        var a = new Array(),w=window,n=w.navigator,ua=n.userAgent
...
function getElements(){//SUPPORTING_Grabs all elements in dom and returns an object
    var e={},de=document.querySelectorAll("*[id]"),ec=document.querySelectorAll("*[class]");
...
function displayAd(){//ALL_IMAGES_LOADED_DISPLAY_AD
    if(!displayAdCalled){
        ...
        main.style.top="-1px",main.style.left="0px";
...
function firePixels(){
    if(iaObject.impression_URL1&&iaObject.impression_URL1!=""&&(myFT.placementProperties.guid.split("9").join("")!=""||myFT.placementProperties.loadPixel=="true"))console.log("pixel1: "+iaObject.impression_URL1),document.body.appendChild(document.createElement("img")).src=iaObject.impression_URL1;
    if(iaObject.impression_URL2&&iaObject.impression_URL2!=""&&(myFT.placementProperties.guid.split("9").join("")!=""||myFT.placementProperties.loadPixel=="true"))console.log("pixel1: "+iaObject.impression_URL2),document.body.appendChild(document.createElement("img")).src=iaObject.impression_URL2;
    if(iaObject.impression_URL3&&iaObject.impression_URL3!=""&&(myFT.placementProperties.guid.split("9").join("")!=""||myFT.placementProperties.loadPixel=="true"))console.log("pixel1: "+iaObject.impression_URL3),document.body.appendChild(document.createElement("img")).src=iaObject.impression_URL3;
}
...
function setElementAttributes(){//MANDATORY - stylize elements per veraible definitions - update as needed.
    var e=[dom.f1_headline_txt,dom.f1_subheadline_txt,
        ...
        styleMap={  "size":"fontSize",                    "color":"color",
                    "fgColor":"color",                      "hex":"color",
                    "bgHex":"backgroundColor",              "fgHex":"color",
                    "bgColor":"backgroundColor",            "align":"textAlign",
                    "xy":"left,top",                        "lb":"left,bottom",
                    "xyw":"left,top,width",                 "lbw":"left,bottom,width",
                    "lt":"left,top",                        "ltw":"left,top,width",
                    "ltwh":"left,top,width,height",         "lbwh":"left,bottom,width,height",
                    "xywh":"left,top,width,height",         "hColor":"H:color",
                    "hBgColor":"H:background-color",        "lines":"numLines",
                    "font":"fontFamily",                    "weight":"fontWeight",
                    "topGap":"marginTop",                   "bottomGap":"marginBottom",
                    "leftGap":"marginLeft",                 "rightGap":"marginRight"},
    
        appends={   "size":"px",                            "color":"","fgColor":"",
                    "bgColor":"",                           "align":"",
                    "xy":"px",                              "lb":"px",
                    "xyw":"px",                             "lbw":"px",
                    "lt":"px",                              "ltw":"px",
                    ...
                    "hBgColor":"",                          "lines":"",
                    "font":"",                              "weight":"",
                    "topGap":"px",                          "bottomGap":"px",
                    "leftGap":"px",                         "rightGap":"px"},
        defaults= {} 
        ...
        for(var i=0;i<e.length;i++){
            ...
            for(var n=0;n<ens.length;n++){
                var ensval=ens[n];
                for(var v in iaObject){dom.frame1.style.top=dom.frame2.style.top=dom.frame3.style.top=dom.frame4.style.top="0px";
