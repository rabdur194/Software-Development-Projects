...
// f4HeroImg.classList.add('vis-hidden');
...
function animateBanner() {
    ...
    animate.to('#f2IconImg', 0.5, {y:0, autoAlpha: 1 }, "-=1");
    animate.to('#f2IconImg', 1, {y:200, autoAlpha: 0 }, "+=3.25");
    ...
    animate.to('#f3IconImg', 0.5, {y: 0, autoAlpha: 1 }, "-=.75");
    animate.to('#f3Txt', 0.5, {y: 0, autoAlpha: 1 }, "+=0");
    
    animate.to(['#f3Txt','#f3IconImg','#f3IconImg'], 0.5, { y:200, autoAlpha: 0 }, "+=2.5");
    ...
    if(isEmpty(dynamicVars.f4_disclaimer_txt)){
        animate.to(['#f3Disc','#f3DiscTxt', '#f2Disc','#f2DiscTxt','#f1Disc','#f1DiscTxt'], 0.5, { y: 200, autoAlpha: 0 }, "-=1");
    } else{
