...
function frameOne() {
    ...
    gsap.to(['#F1_bg'], { duration: 4, scale: 1.2, transformOrigin: "80px 150px", z: 0.1, rotationZ: 0.01, force3D: true });

    gsap.to('#GL_line', { delay: .2, duration: .4, clip: "rect(0px 160px 600px 0px)" })
...
function frameTwo() {
    ...
    gsap.to(['#F2_bg'], { duration: 4, scale: 1.2, transformOrigin: "80px 150px", z: 0.1, rotationZ: 0.01, force3D: true });
...
function endFrame() {
    ...
    gsap.from(['#EF_bg'], { duration: 3, transformOrigin: "80px 150px", scale: 1.2, x: 0, y: 0, z: 0.1, rotationZ: 0.01, force3D: true });
