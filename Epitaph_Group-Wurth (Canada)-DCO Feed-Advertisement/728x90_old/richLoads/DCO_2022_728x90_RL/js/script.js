...

{
    ...
    initialize: function() {
        ...
        if(myFT.instantAds.feedEndpoint.indexOf("https://")!=0){console.log("THIS"),Ad.FEED.feedLoadError()}else
        {ftFeed.getFeed(Ad.FEED.feedLoaded, Ad.FEED.feedLoadError);}
        ...
        createAd: function(obj) {
           ...
           // hitall.onmouseout = Ad.NAV.hitOut;
            ...
            function createSlide (count) {
                ...
                itemText.setAttribute("class","itemText abs");
                itemTextPrice.setAttribute("class","itemPrice abs");
                itemImg.setAttribute("class","itemImg abs");
                ...
                itemImg.src = Ad.feedObj[count].powerfeeds_image.replace("w=500&h=500","w=130&h=130");
                itemContainer.appendChild(itemTextPrice);
...
/*
           ...
           if(Ad.feedObj.length<2)document.getElementById("left_arrow").style.display=document.getElementById("right_arrow").style.display="none";
            if(myFT.instantAds.headlineTxt.length>0||myFT.instantAds.promoTxt.length>0){
                ...
                var hl=document.getElementById("headlineTxt"),pt=document.getElementById("promoTxt");
                ...
                var hls=myFT.instantAds.headlineTxt_size_hex_xy.split("|"),pts=myFT.instantAds.promoTxt_size_hex_xy.split("|");
                ...
                pt.style.zIndex=101;hl.style.zIndex=102;
        ...
        createFail(){
            ...
            var ha=document.getElementById("hitall"),fi=ha.parentElement.insertBefore(document.createElement("img"),ha),hides=["left_arrow","right_arrow","frame1","hitall","textLayer"];
