        ...
        DRAW: {
            ...
            createAd: function(obj) {
                ...
                function createSlide(count) {
                    ...
                    maincontentParent = document.createElement("div"),
                    ...
                    maincontentParent.setAttribute("class", "main-content");
                    ...
                    itemContainer.appendChild(maincontentParent);
                    maincontentParent.appendChild(contentParent);
                    maincontentParent.appendChild(imgParent);
                ...
                if (myFT.instantAds.headlineTxt.length > 0 || myFT.instantAds.promoTxt.length > 0) {
                    ...
                    if (myFT.instantAds.headlineTxt.length > 0) {
                        document.head.appendChild(document.createElement("style")).innerHTML = `.itemText,.itemPrice{opacity:0;}.itemImg{left:0px;}`;
                        ...
                        var ccc = document.getElementById("slider_frame");
                        ccc.style.width = 100 + "px";
